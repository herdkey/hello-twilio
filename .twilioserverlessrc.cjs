// https://www.twilio.com/docs/labs/serverless-toolkit/configuration#configuration-options
...
module.exports = {
  ...
  env: 'twilio.env', // Path to .env file for environment variables that should be installed
